...
export function fetchSongId(title) {
  return function (dispatch) {
    ...
    return fetch('http://api.musixmatch.com/ws/1.1/track.search?&q_track=' + title + '&page_size=1&s_track_rating=desc&apikey=398e4af0e0547e98d4dc67ebe1f65bab').then(
...
export function fetchLyrics(title, artist, musicMatchId, localSongId, dispatch) {
  return fetch('http://api.musixmatch.com/ws/1.1/track.lyrics.get?track_id=' + musicMatchId + '&apikey=398e4af0e0547e98d4dc67ebe1f65bab').then(
    response => response.json(),
